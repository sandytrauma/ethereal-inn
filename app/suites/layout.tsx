...
export const metadata: Metadata = {
  title: "The Suites | Etherealinn Gallery",
  description: "Explore the architectural sanctuary of Etherealinn. From our Signature rooms to the Grand Obsidian Penthouse, discover luxury redefined in Gurugram.",
  openGraph: {
    title: "Etherealinn | The Suite Gallery",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Etherealinn Luxury Suite",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "The Suites | Etherealinn",
