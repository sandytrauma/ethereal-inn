...
export const metadata: Metadata = {
  ...
  description: "Experience the cloud kitchen and fine dining of Ethereal Inn. Artisanal flavors, global journeys, and 24/7 gourmet service in Gurugram.",
  openGraph: {
    title: "Urban Ambrosia | Ethereal Inn Dining",
