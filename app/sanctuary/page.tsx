    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 font-sans antialiased selection:bg-amber-500/30 selection:text-amber-200 relative">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pb-32">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* CATALOGUE ITEM: LUXURY SUITES (Using Catalogue_2.avif) */}
          <div className="group relative flex flex-col bg-slate-950/50 border border-white/10 rounded-[40px] backdrop-blur-xl transition-all duration-500 hover:bg-slate-950/80 hover:border-amber-500/40 shadow-xl overflow-hidden">
            ...
            <div className="p-8 pt-4 flex flex-col flex-grow">
              ...
              <h3 className="text-2xl font-black text-white mb-3 tracking-tight">Luxury Guest accomodations</h3>
              ...
              <a 
                href={links.suites} 
                target="_blank"
                className="flex items-center justify-between w-full bg-white/5 p-4 rounded-2xl group-hover:bg-amber-500 group-hover:text-black transition-all font-bold text-[11px] uppercase tracking-widest"
              >
                Book A Suite <ArrowUpRight size={16} />
              </a>
            </div>
          </div>

          {/* CATALOGUE ITEM: URBAN AMBROSIA (Using Royalty-Free Premium Culinary Asset) */}
          <div className="group relative flex flex-col bg-slate-950/50 border border-white/10 rounded-[40px] backdrop-blur-xl transition-all duration-500 hover:bg-slate-950/80 hover:border-purple-500/40 shadow-xl overflow-hidden">
            ...
            <div className="p-8 pt-4 flex flex-col flex-grow">
              ...
              <a 
                href={links.culinary} 
                target="_blank"
                className="flex items-center justify-between w-full bg-white/5 p-4 rounded-2xl group-hover:bg-purple-500 group-hover:text-black transition-all font-bold text-[11px] uppercase tracking-widest"
              >
          ...
          {/* CATALOGUE ITEM: GLAM STUDIO (Using Royalty-Free Premium Makeup Vanity Asset) */}
          <div className="group relative flex flex-col bg-slate-950/50 border border-white/10 rounded-[40px] backdrop-blur-xl transition-all duration-500 hover:bg-slate-950/80 hover:border-pink-500/40 shadow-xl overflow-hidden">
            ...
            <div className="p-8 pt-4 flex flex-col flex-grow">
              ...
              <a 
                href={links.glam} 
                target="_blank"
                className="flex items-center justify-between w-full bg-white/5 p-4 rounded-2xl group-hover:bg-pink-500 group-hover:text-black transition-all font-bold text-[11px] uppercase tracking-widest"
              >
      ...
      <footer className="relative z-10 border-t border-white/5 py-16 px-6 text-center bg-slate-950/70 backdrop-blur-md">
        <div className="max-w-4xl mx-auto">
          ...
          <a 
            href={links.general}
            target="_blank"
            className="inline-flex items-center gap-4 text-amber-500 hover:text-white transition-colors text-lg font-bold group"
          >
